      ...
      <Card.Footer className="text-muted p-4 mt-5">
        <Row className="text-center mb-4">
          ...
          <Col md={4}>
            ...
            <p>Escribinos al WhatsApp 📱: +54 388-4348958</p>
          </Col>
        </Row>
        <Row className="text-center mb-4">
          <Col md={4}>
          ...
          <Col md={4}>
            ...
            <Row>
              ...
              <Col xs={6} md={4}>
                <a href="#" target="_blank">
                  <img
                    src="https://img.icons8.com/win10/512/whatsapp.png"
                    alt="Whatsapp"
                    width="32"
                  />
                </a>
        ...
        <Row className="text-center mt-3">
          <Col>
            <p> ©️ StyleScript -G22- 2025. Todos los derechos reservados.</p>
            <p>Hecho con 🧑‍💼,🧑‍💼, 💻 y  🖥️ .</p>
          </Col>
        </Row>
      </Card.Footer>
